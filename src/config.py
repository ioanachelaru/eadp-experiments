...
RAW_DATA = {
    ...
    "ant_ivy_coverage_pattern": "data/Coverage-AntIvy-*-filename.csv",
}
...
DATASETS = {
    ...
    "ant-ivy-effort-cov": {
        "file": "data/Ant-Ivy-effort-cov.csv",
        "sheet": None,
        "header_row": 0,
        "feature_name_row": None,
        "label_column": "Bug",
        "version_column": "Ant version",
        "release_order": "ant-ivy",
        "description": "Ant-Ivy: 149 effort + 5 coverage features (154 total)",
    },
    "ant-ivy-top30-sm-only": {
        "file": "data/Ant-Ivy-top30-sm-only.csv",
        "sheet": None,
        "header_row": 0,
        "feature_name_row": None,
        "label_column": "Bug",
        "version_column": "Ant version",
        "release_order": "ant-ivy",
        "description": "Ant-Ivy: top-30 SM features (30 total)",
    },
    "ant-ivy-effort26-cov": {
        "file": "data/Ant-Ivy-effort26-cov.csv",
        "sheet": None,
        "header_row": 0,
        "feature_name_row": None,
        "label_column": "Bug",
        "version_column": "Ant version",
        "release_order": "ant-ivy",
        "description": "Ant-Ivy: 26 common effort + 5 coverage features (31 total)",
    },
    "ant-ivy-top30-sm-effort26-cov": {
        "file": "data/Ant-Ivy-top30-sm-effort26-cov.csv",
        "sheet": None,
        "header_row": 0,
        "feature_name_row": None,
        "label_column": "Bug",
        "version_column": "Ant version",
        "release_order": "ant-ivy",
        "description": "Ant-Ivy: 30 SM + 26 effort + 5 coverage (61 total)",
    },
    "ant-ivy-top30-sm-effort-cov": {
        "file": "data/Ant-Ivy-top30-sm-effort-cov.csv",
        "sheet": None,
        "header_row": 0,
        "feature_name_row": None,
        "label_column": "Bug",
